...
|---|---|---|---|
| `2026-07-14_Prompt_Auditoria_Sync-Skills-Superpowers.md` | **ATIVO** | Claude Sonnet 4.6 (Claude Code) | Auditoria — Adição de §4 (skills globais superpowers) em sync-skills/SKILL.md |
